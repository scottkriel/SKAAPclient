...
ssh_struct = ssh2_config(HOSTNAME,USERNAME,PASSWORD);
...
figure 
plot(freqMAT(:,1)./1e06,magMAT,'LineStyle','none','Marker','.','MarkerSize',1e-12); hold on,
% plot(freqMAT(:,1)./1e06,magMAT(end,:),'LineStyle','none','Marker','.','MarkerSize',1e-12)
xlabel('Frequency (MHz)')
ylabel('Magnitude (dB)')
grid on 
grid minor
